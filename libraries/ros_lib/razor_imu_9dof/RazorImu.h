#ifndef _ROS_razor_imu_9dof_RazorImu_h
#define _ROS_razor_imu_9dof_RazorImu_h
...
namespace razor_imu_9dof
{
  ...
  class RazorImu : public ros::Msg
  {
    ...
    const char * getType(){ return "razor_imu_9dof/RazorImu"; };
