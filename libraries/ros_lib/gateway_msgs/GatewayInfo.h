...
namespace gateway_msgs
{
  ...
  class GatewayInfo : public ros::Msg
  {
    public:
      ...
      gateway_msgs::RemoteRule st_flipped_connections;
      gateway_msgs::RemoteRule * flipped_connections;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(flipped_connections_lengthT > flipped_connections_length)
        this->flipped_connections = (gateway_msgs::RemoteRule*)realloc(this->flipped_connections, flipped_connections_lengthT * sizeof(gateway_msgs::RemoteRule));
      offset += 3;
      flipped_connections_length = flipped_connections_lengthT;
      for( uint8_t i = 0; i < flipped_connections_length; i++){
      offset += this->st_flipped_connections.deserialize(inbuffer + offset);
        memcpy( &(this->flipped_connections[i]), &(this->st_flipped_connections), sizeof(gateway_msgs::RemoteRule));
      }
